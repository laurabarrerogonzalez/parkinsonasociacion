      ...
      <div className="bodys12">
        <div className="process-wrapper">
          <div id="progress-bar-container">
            <ul>
              <li
                className={`step step01 ${currentStep === 1 ? "active" : ""}`}
                onClick={() => handleStepClick(1)}
              >
                <p>Estadío I</p>
              </li>
              <li
                className={`step step02 ${currentStep === 2 ? "active" : ""}`}
                onClick={() => handleStepClick(2)}
              >
                <p>Estadío II</p>
              </li>
              <li
                className={`step step03 ${currentStep === 3 ? "active" : ""}`}
                onClick={() => handleStepClick(3)}
              >
                <p>Estadío III</p>
              </li>
              <li
                className={`step step04 ${currentStep === 4 ? "active" : ""}`}
                onClick={() => handleStepClick(4)}
              >
                <p>Estadío IV</p>
              </li>
              <li
                className={`step step05 ${currentStep === 5 ? "active" : ""}`}
          ...
          <div id="progress-content-section">
            ...
            >
              ...
              <p>
                ...
                <li className="li-state">
                  Disminución del braceo al caminar, arrastrando un poco los
                  pies
                </li>
              </p>
            </div>
            ...
            >
              ...
              <p>
                <li className="li-state">
                  Dificultades al caminar: se acorta el paso, dificultades en
                  los giros
                </li>
                <li className="li-state">
                ...
                <li className="li-state">
                  Síntomas de relación con los fármacos: fenómenos on-off (miedo
                  e inseguridad), discinesias y problemas conductuales
            ...
            >
              ...
              <p>
                ...
                <li className="li-state">
                  Aumento progresivo del tiempo off. Gran parte del tiempo
                  sentado o en cama
                </li>
