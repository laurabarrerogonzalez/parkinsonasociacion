...
const Symptoms = () => {
  return (
    <>
      ...
      <div className="Bodys">
        <HTMLFlipBook style={{ width: "80%" }} width={340} height={500}>
          <Page number="1">
            <div>
              <h2>¿Qué es el Parkinson?</h2>{" "}
              <p className="pakinson-p">
                El Parkinson es un trastorno neurodegenerativo de curso crónico,
                progresivo e irreversible
              </p>
              <ul className="parkinson-ul">
                <li className="parkinson-li">
                  Degenerativa: disminución de la calidad
                </li>
                <li className="parkinson-li">Neurológico: sistema nervioso</li>
                <li className="parkinson-li">Crónico: de larga duración</li>
                <li className="parkinson-li">
                  Progresivo: con una evolución en etapas
                </li>
              </ul>
            </div>
            ...
            <div className="parkinson-what">
              ...
              <p className="pakinson-p">
                Células de la sustancia negra funcionan mal y mueren, disminuye
                producción de dopamina.
              </p>
              <p className="pakinson-p">
                Dopamina: neurotransmisor de información para realizar
                movimientos con normalidad
              </p>
            </div>
          ...
          <Page number="2">
            <h2 className="parkinson-h1">Síntomas Motores</h2>
            <div>
              <h2 className="parkinson-si">Principales</h2>
              <ul>
                <li className="parkinson-si">
                  BRADICINESIA - lentitud en el movimiento - bloqueo y
                  dificultades en marcha
                </li>
                <li className="parkinson-si">
                  RIGIDEZ- aumento del tono muscular - amplitud del movimiento
                  menor, dolor y calambres, postura encorvada
                </li>
                <li className="parkinson-si">
            ...
            <div>
              ...
              <ul>
                <li className="parkinson-si">
                  HIPOMIMIA: disminución expresión facial debido a rigidez
                </li>
                <li className="parkinson-si">
                  HIPOFONÍA: disminución tono voz
                </li>
                <li className="parkinson-si">
                ...
                <li className="parkinson-si">
                  DISCINESIAS: movimientos involuntarios provocados por la
                  medicación
                </li>
              </ul>
            </div>
          ...
          <Page number="3">
            ...
            <div>
              ...
              <ul>
                ...
                <li className="parkinson-li">
                  TRASTORNOS CONDUCTUALES: control de impulso, hipersexualidad
                </li>
                <li className="parkinson-li">
                  ALUCINACIONES Y DELIRIOS: efecto de medicación
                </li>
                <li className="parkinson-li">
                  ALTERACIONES COGNITIVAS: enlentecimiento del procesamiento de
                  información, alteración función ejecutiva y déficit
                  atencionales, visuales, espacial y de memoria
                </li>
              </ul>
            </div>
          ...
          <Page number="4">
            ...
            <div>
              ...
              <ul>
                ...
                <li className="parkinson-si">
                  HIPOSMIA/ANOSMIA: disminución o pérdida del olfato
                </li>
              </ul>
            </div>
          ...
          <Page number="5">
            <h2>SINTOMAS NO MOTORES</h2> <br /> <br />
            <div>
            ...
            <div>
              ...
              <ul>
                ...
                <li className="parkinson-si">
                  AUMENTO DE SUDORACIÓN Y SEBORREA
                </li>
          ...
          <Page number="6">
            <h2>No dudes en pedir ayuda</h2> <br /> <br />
            <img
              className="img-book"
              src="https://res.cloudinary.com/dit2zhtwz/image/upload/v1699098000/istockphoto-1461330630-612x612_ysetew.jpg"
            />
          </Page>
        </HTMLFlipBook>
      </div>
