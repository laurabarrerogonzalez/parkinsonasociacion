...
const Proyects = () => {
  const [cardInfo1, setCardInfo1] = useState({
    title: "Imagen Fiel",
    description: "Imagen Fiel es un proyecto que nace con el fin de combatir la estigmatización y el rechazo social de las personas afectadas de Parkinson, llevando a la población general información con la finalidad de conseguir una imagen fiel de las personas con Parkinson.",
  ...
  const cambiarInformacion1 = () => {
    setCardInfo1({
      title: "Objetivos",
      description: "Sensibilizar y formar a la población sobre la discapacidad que puede llegar a generar la enfermedad de Parkinson con el fin de desmitificar la sintomatología y evitar estigmatizar a este tipo de personas con discapacidad facilitando su integración.",
      backgroundColor: "linear-gradient(to bottom, #ffd700, #ffc700)",
    });
  };
  ...
  const cambiarInformacion2 = () => {
    setCardInfo2({
      ...
      description: (
        <>
          <p>Lorem ipsum dolor sit amet consectetur adipiscing, elit placerat condimentum ultrices proin dignissim, maecenas libero ac mus augue, nascetur mattis netus sem dictumst. <br></br> </p>
          <h4>Más info en:</h4>
          <img
      ...
      <div className="project-container">
        ...
        <div className="project-image">
          <img
            ...
            alt="Project Image"
            style={{ width: "300px", height: "320px", borderRadius: "10px", backgroundColor: "#f9d4b4" }}
          />
        </div>
