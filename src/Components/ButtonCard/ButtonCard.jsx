        ...
        <div class="cardt3">
          ...
          <div class="content-buton">
            <p className="text-buttoncard">
              ...
              ajustes en la estimulación. No todos los pacientes son candidatos
              para la DBS Therapy, ya que se considera principalmente para
              aquellos que no responden adecuadamente a la medicación,
              experimentan periodos de ineficacia de los medicamentos o sufren
              de discinesias. La decisión de recibir esta terapia debe ser
              evaluada por un médico con experiencia en DBS. En resumen, la DBS
              Therapy es una opción quirúrgica para reducir los síntomas
              neurológicos, pero requiere una evaluación cuidadosa por parte de
        ...
        <div class="cardt4">
          ...
          <div class="content-buton">
            <p className="text-buttoncard">
              {" "}
              <p className="TNF">
                <strong>Fisioterapia:</strong> Ayuda a retrasar la progresiónde
                los trastornosy motores y mantener la condición física
                necesaria, permitiendo mayor autonomía.{" "}
              </p>
              <p className="TNF">
                <strong>Terapia ocupacional:</strong> conseguir la máxima
                autonomía e independencia para mejorar y/o mantener la calidad
                de vida
              </p>
              <p className="TNF">
                <strong>Logopedia:</strong> rehabilitación de los trastornos del
                lenguaje, de la comunicación y/o deglución asociados a la EP o
                minimizar sus consecuencias
              </p>
              <p className="TNF">
                <strong>Psicología:</strong> mejorar la calidad de vida de los
                afectados de parkinson ayudando tanto al afectado como a todo su
                entorno (cuidador/familiares) a aceptar y convivir con la
                enfermedad y su sintomatología
              </p>
              <p className="TNF">
                <strong>Otros profesionales: </strong>
                <ul>
                  <li>Urólogo</li>
                  <li>Endocrino</li>
                  <li>Enfermería</li>
          ...
          <div class="item item--inspire">
            <Link to="/revitalization">
              ...
              <span>
                <strong>Mira nuestros servicios</strong>
              </span>
            </Link>
          </div>
        </div>
