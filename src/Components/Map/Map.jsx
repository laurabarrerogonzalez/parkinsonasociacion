...
function Mapa() {
  ...
  return (
    <MapContainer center={locations[0].position} zoom={8} style={{ height: "70vh", width: "90%", marginLeft: "25px", marginRight: "auto", marginTop: "15px", marginBottom: "15px", border: "2px solid black", boxShadow: "4px 4px 8px rgba(0, 0, 0, 1)"}}>
      <TileLayer
